...
namespace FootballManagerApi.Controllers
{
    ...
    [ApiController]
    public class NationalTeamssController : ControllerBase
    {
        private readonly ApplicationDbContext _context;

        public NationalTeamssController(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: api/NationalTeamss
        [HttpGet]
